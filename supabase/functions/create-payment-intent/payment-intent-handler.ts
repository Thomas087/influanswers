/**
 * Shared payment intent handler for Supabase Edge Functions
 * This file contains the common logic for creating Stripe payment intents
 */
...
export async function handlePaymentIntentRequest(
  ...
  const stripeSecretKey = Deno.env.get(stripeSecretKeyEnvVar)
  if (!stripeSecretKey) {
    return new Response(
